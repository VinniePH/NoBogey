...
export async function getAvailableCaddies(_courseId: string, _startsAt: string): Promise<CaddieCandidate[]> {
...
export async function getCaddieAvailability(_caddieId: string, _startsAt: string): Promise<CaddieAvailability | null> {
...
export async function getWalkInCoverageGaps(_courseId: string, _date: string): Promise<CaddieAvailability[]> {
