    ...
    <View style={styles.backdrop}>
      ...
      <View accessibilityLabel={`${caddie.displayName} booking details`} accessibilityViewIsModal style={[styles.sheet, { paddingBottom: Math.max(insets.bottom, spacing.md) }]}>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator>
          ...
          <Section title="Preferred-caddie request"><Text selectable style={styles.scheduleNote}>This caddie is a preference, not a guaranteed assignment. You’ll review the request before sending it to the club.</Text></Section>
        </ScrollView>
        <View style={styles.actionArea}><Pressable accessibilityLabel={`Request ${caddie.displayName} as preferred caddie`} accessibilityRole="button" onPress={onBook} style={styles.bookButton}><Text style={styles.bookText}>Choose tee time</Text></Pressable></View>
      </View>
    </View>
  </Modal>;
}
