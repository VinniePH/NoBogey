...
type DashboardTab = "roster" | "portfolio";
    ...
    <SafeAreaView edges={["top", "bottom"]} style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <ResponsiveContent style={styles.content}>
          ...
          <NextClientCard clientNotified={clientNotified} onNotify={() => setClientNotified(true)} />
          ...
          <View accessibilityRole="tablist" style={styles.tabs}>
            <Tab active={false} disabled label="Schedule" />
          ...
          {tab === "roster" ? <RosterPanel /> : <PortfolioPanel />}
        </ResponsiveContent>
      </ScrollView>
    </SafeAreaView>
  );
...
function NextClientCard({ clientNotified, onNotify }: { clientNotified: boolean; onNotify: () => void }) {
  return <View style={styles.nextClient}>
    <View style={styles.clientIcon}><Text style={styles.clientIconText}>◴</Text></View>
...
function Highlight({ label, value }: { label: string; value: string }) { return <View style={styles.highlight}><Text style={styles.highlightLabel}>{label}</Text><Text style={styles.highlightValue}>{value}</Text></View>; }
