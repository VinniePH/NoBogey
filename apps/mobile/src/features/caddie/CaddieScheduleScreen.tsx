...
const styles = StyleSheet.create({
    backdrop: { backgroundColor: "rgba(23, 32, 27, 0.45)", flex: 1, justifyContent: "flex-end" }, booked: { backgroundColor: "#236241", borderColor: "#236241" }, calendar: { gap: spacing.sm }, calendarContent: { flexGrow: 1 }, calendarContentNarrow: { minWidth: 560 }, calendarGrid: { gap: spacing.sm, width: "100%" }, calendarScroller: { width: "100%" }, card: { backgroundColor: "#FFFFFF", borderColor: "#E0E7DF", borderRadius: 18, borderWidth: 1, gap: spacing.lg, padding: spacing.lg }, closeButton: { alignItems: "center", borderColor: colors.border, borderRadius: 18, borderWidth: 1, height: 36, justifyContent: "center", width: 36 }, closeText: { color: colors.ink, fontSize: 24, lineHeight: 25 }, day: { alignItems: "center", flex: 1, gap: 2 }, dayHeader: { flexDirection: "row", marginBottom: spacing.xs }, dayLabel: { color: "#5C7467", fontFamily: fonts.mono, fontSize: 11, letterSpacing: 1 }, doneButton: { alignItems: "center", backgroundColor: "#236241", borderRadius: radius.lg, flexShrink: 0, justifyContent: "center", minHeight: 44, minWidth: 72, paddingHorizontal: spacing.lg }, doneButtonNarrow: { alignSelf: "stretch", width: "100%" }, doneText: { color: colors.surface, fontSize: 13, fontWeight: "800", textAlign: "center" }, editButton: { alignItems: "center", backgroundColor: "#236241", borderRadius: 14, flexDirection: "row", gap: 6, minHeight: 42, paddingHorizontal: spacing.md }, editButtonDisabled: { opacity: 0.5 }, editButtonNarrow: { alignSelf: "stretch", justifyContent: "center" }, editIcon: { color: colors.surface, fontSize: 16 }, editText: { color: colors.surface, fontSize: 12, fontWeight: "800" }, legend: { flexDirection: "row", flexWrap: "wrap", gap: spacing.md }, legendDot: { borderRadius: 99, borderWidth: 1, height: 12, width: 12 }, legendItem: { alignItems: "center", flexDirection: "row", gap: 6 }, legendNarrow: { justifyContent: "center" }, legendText: { color: "#5C7467", fontFamily: fonts.mono, fontSize: 11, letterSpacing: 1 }, legendUnavailable: { opacity: 0.45 }, lightSlotText: { color: colors.surface }, modalCard: { backgroundColor: "#F9F8F4", borderTopLeftRadius: 22, borderTopRightRadius: 22, gap: spacing.lg, maxHeight: "92%", maxWidth: 620, padding: spacing.lg, width: "100%" }, modalFooter: { alignItems: "center", flexDirection: "row", gap: spacing.md, justifyContent: "space-between" }, modalFooterNarrow: { alignItems: "stretch", flexDirection: "column" }, modalHeader: { alignItems: "flex-start", flexDirection: "row", gap: spacing.md, justifyContent: "space-between" }, off: { backgroundColor: "#61776B", borderColor: "#61776B" }, open: { backgroundColor: "#F6F5F1", borderColor: "#C7D3CB" }, panelHeader: { alignItems: "flex-start", flexDirection: "row", gap: spacing.md, justifyContent: "space-between" }, panelHeaderNarrow: { alignItems: "stretch", flexDirection: "column" }, row: { alignItems: "center", flexDirection: "row", gap: spacing.sm }, sheetHandle: { alignSelf: "center", backgroundColor: "#B8C3BA", borderRadius: 999, height: 4, marginBottom: -4, width: 40 }, slot: { alignItems: "center", borderRadius: radius.lg, borderWidth: 1, flex: 1, height: 56, justifyContent: "center" }, slotText: { color: "#236241", fontFamily: fonts.mono, fontSize: 11, fontWeight: "800" }, slotUnavailable: { backgroundColor: "#EFEEE9", borderColor: "#C7D3CB" }, subtitle: { color: colors.textMuted, fontSize: 13, marginTop: 3 }, time: { color: "#5C7467", fontFamily: fonts.mono, fontSize: 11, textAlign: "right", width: 62 }, timeColumn: { width: 62 }, title: { color: colors.ink, fontSize: 20, fontWeight: "900" }
});
