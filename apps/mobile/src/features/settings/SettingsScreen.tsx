...
type SettingsSheet = "contact" | "notifications" | "payment" | "preferences" | "support";
type SettingsItem = {
  detail: string;
  disabled?: boolean;
